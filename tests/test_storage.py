...
class DataEntityTest(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.test_item_1 = MTDataItem(
            "test_1", "test_1", "SYSTEM", "SAMPLE", self.test_device, self.test_device
        )
...
class BufferTest(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.test_item_2 = MTDataItem(
            "test_2", "test_2", "SYSTEM", "SAMPLE", self.test_device, self.test_device
        )
    ...
    def testBufferGet(self):
        ...
        test_item = MTDataItem(
            "test_1", "test_1", "SYSTEM", "SAMPLE", test_device, test_device
        )
